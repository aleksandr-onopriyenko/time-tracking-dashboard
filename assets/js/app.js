...
class DashboardItem {
      ...
      <div class="dashboard__item dashboard__item--${id}">
        <article class="tracking-card">
          <header class="tracking-card__header">
            <h2 class="tracking-card__title">${title}</h2>
            <img src="assets/img/icon-ellipsis.svg" alt="menu" class="tracking-card__menu">
          </header>
  ...
  changeView(view) {
    ...
    this.prev.innerText = `Last ${DashboardItem.PERIODS[this.view]} - ${previous}hr`
  }
}
